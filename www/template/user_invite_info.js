...
return templates['user_invite_info'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<h4 class=\"ui header\">\n  <div class=\"content\">\n    Описание группы <a href=\"#group/feed/"
    ...
    + ((stack1 = (helpers.markdown || (depth0 && depth0.markdown) || helpers.helperMissing).call(alias3,(depth0 != null ? depth0.group_description : depth0),{"name":"markdown","hash":{},"data":data})) != null ? stack1 : "")
    + "\n</div>\n<div class=\"ui center aligned basic segment\">\n  <div class=\"ui one small statistics\">\n    <div class=\"statistic\">\n      <div class=\"value\">\n"
    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.is_voted : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(6, data, 0),"data":data})) != null ? stack1 : "")
    + "    </div>\n  </div>\n</div>\n";
},"useData":true});
});