...
return templates['one_comment_view'] = template({"1":function(container,depth0,helpers,partials,data) {
    return "      <div class=\"ui yellow label\">новый</div>\n";
},"3":function(container,depth0,helpers,partials,data) {
    return "      <a class=\"edit action\">Редактировать</a>\n";
  ...
  return "<div class=\"comment\">\n  <div class=\"avatar\">\n    <i class=\"user icon\"></i>\n  </div>\n  <div class=\"content\">\n    <a class=\"author\" href=\"#user/"
    ...
    + "</div>\n"
    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.is_new : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "    </div>\n    <div class=\"text\">\n      "
    ...
    + "\n    </div>\n    <div class=\"actions\">\n      <a class=\"quote action\">Цитировать</a>\n"
    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.is_editable : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "    </div>\n  </div>\n</div>\n";
},"useData":true});
});